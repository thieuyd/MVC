...
class ProductController extends BaseController
{
    ...
    private function validateForm(&$dataValidate = array(), $itemPost = array(), &$data = array())
    {
        $dataValidate = array(
            'name' => array(
                'label' => 'product name',
                'input' => trimInput(getValue($itemPost[0])),
                'rule' => array('required'),
    ...
    {
        $dataInput['pd_name'] = trimInput(getValue($itemPost[0]));
        $dataInput['pd_price'] = trimInput(getValue($itemPost[1]));
        $dataInput['pd_des'] = trimInput(getValue($itemPost[2]));
    ...
    {
        $data['product']['pd_name'] = trimInput(getValue($itemPost[0]));
        $data['product']['pd_price'] = trimInput(getValue($itemPost[1]));
        $data['product']['pd_des'] = trimInput(getValue($itemPost[2]));
