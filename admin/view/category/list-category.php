                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        <thead>
                            <tr>
                                ...
                                <th width="15%" class="sorting"><a href="<?php pathShow(SHOW_CATEGORY,'ct_id', getSortType('ct_id'), $_GET['page'], $_GET['search']); ?>">ID</a></th>
                                <th width="35%" class="sorting"><a href="<?php pathShow(SHOW_CATEGORY, 'ct_name', getSortType('ct_name'), $_GET['page'], $_GET['search']); ?>">Category Name</a></th>
                                <th width="20%" class="sorting"><a href="<?php pathShow(SHOW_CATEGORY, 'ct_status', getSortType('ct_status'), $_GET['page'], $_GET['search']); ?>">Activate</a></th>
                                <th width="10%" class="sorting"><a href="<?php pathShow(SHOW_CATEGORY, 'ct_time_created', getSortType('ct_time_created'), $_GET['page'], $_GET['search']); ?>">Time Created</a></th>
                                <th width="10%" class="sorting"><a href="<?php pathShow(SHOW_CATEGORY, 'ct_time_update', getSortType('ct_time_update'), $_GET['page'], $_GET['search']); ?>">Time Updated</a></th>
