            ...
            <div class="block-fluid">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <input type="text" placeholder="some text value..." name="name" value="<?php getData($product, 'pd_name'); ?>"/>
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <input type="text" placeholder="some text value..." name="price" value="<?php getData($product, 'pd_price'); ?>" />
                            <p id='notifyMessage'><?php getData($message, 'price'); ?></p>
                        </div>
                        <div class="clear"></div>
                    </div> 
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            <textarea name="des" placeholder="Textarea field placeholder..." ><?php getData($product, 'pd_des'); ?></textarea>
                            <p id='notifyMessage'><?php getData($message, 'des'); ?></p>
                        </div>
                        <div class="clear"></div>
                    </div> 
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <?php }?>
                                <p id='notifyMessage'><?php getData($message, 'img'); ?></p>
                        </div>
                        <div class="clear"></div>
                    </div> 
                    ...
                    <div class="row-form">
                        ...
                        <div class="span9">
                            ...
                            <p id='notifyMessage'><?php getData($message, 'status'); ?></p>
                        </div>
                        <div class="clear"></div>
                    </div>
